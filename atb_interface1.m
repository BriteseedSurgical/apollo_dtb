function varargout = atb_interface1(varargin)
% ATB_INTERFACE1 MATLAB code for atb_interface1.fig
%      ATB_INTERFACE1, by itself, creates a new ATB_INTERFACE1 or raises the existing
%      singleton*.
%
%      H = ATB_INTERFACE1 returns the handle to a new ATB_INTERFACE1 or the handle to
%      the existing singleton*.
%
%      ATB_INTERFACE1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ATB_INTERFACE1.M with the given input arguments.
%
%      ATB_INTERFACE1('Property','Value',...) creates a new ATB_INTERFACE1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before atb_interface1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to atb_interface1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help atb_interface1

% Last Modified by GUIDE v2.5 22-Jun-2022 14:47:48

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @atb_interface1_OpeningFcn, ...
                   'gui_OutputFcn',  @atb_interface1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before atb_interface1 is made visible.
function atb_interface1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to atb_interface1 (see VARARGIN)

% Choose default command line output for atb_interface1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes atb_interface1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = atb_interface1_OutputFcn(hObject, eventdata, handles) 
...
% --- Executes on button press in duplicate_acction.
function duplicate_acction_Callback(hObject, eventdata, handles)
% hObject    handle to duplicate_acction (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes on button press in cont_btn.
function cont_btn_Callback(hObject, eventdata, handles)
% hObject    handle to cont_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
